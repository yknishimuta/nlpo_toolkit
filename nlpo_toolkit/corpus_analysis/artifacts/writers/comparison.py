...
def write_comparison_csv_artifact(artifact: PlannedArtifact, *, result: ConfiguredComparisonResult) -> None:
...
def _summary(result: ConfiguredComparisonResult, *, csv_name: str) -> JsonObject:
    spec = result.spec
...
def render_comparisons_json(results: Sequence[ConfiguredComparisonResult], *, csv_names: Mapping[str, str]) -> JsonObject:
