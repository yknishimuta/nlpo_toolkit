...
from nlpo_toolkit.count_vocabula.config import NLPConfig, load_config
from nlpo_toolkit.count_vocabula.features import FeatureOptions, build_feature_rows
...
def _count_group(text: str, nlp, **kwargs):
    from nlpo_toolkit.count_vocabula.nlp_hooks import count_group
