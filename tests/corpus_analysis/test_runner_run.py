...
def test_run_minimal_success(tmp_path: Path, monkeypatch):
    ...
    monkeypatch.setattr(analysis_outputs_mod, "write_frequency_csv", write_frequency_csv)
...
def test_run_dictcheck_writes_known_unknown(tmp_path: Path, monkeypatch):
    ...
    calls = []
    monkeypatch.setattr(analysis_outputs_mod, "write_frequency_csv",
