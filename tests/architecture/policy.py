...
MODULE_ROLE_POLICIES: tuple[ModuleRolePolicy, ...] = (
    ...
    ModuleRolePolicy(
        ...
        exact_modules=(
            ...
            "nlpo_toolkit.corpus_analysis.features.sampling",
            ...
            "nlpo_toolkit.stylometry.verification_evaluation_models",
            ...
            "nlpo_toolkit.corpus_analysis.features.corpus_verification_models",
            "nlpo_toolkit.corpus_analysis.features.corpus_verification_evaluation_models",
            "nlpo_toolkit.corpus_analysis.features.vocabulary_audit",
        ),
        recursive_packages=(
    ...
    ModuleRolePolicy(
        ...
        exact_modules=(
            ...
            "nlpo_toolkit.corpus_analysis.features.corpus_stylometry_support",
            "nlpo_toolkit.corpus_analysis.features.corpus_verification_service",
            "nlpo_toolkit.corpus_analysis.features.corpus_verification_evaluation_service",
        ),
...
PURE_MODULES = (
    ...
    f"{CA}.features.corpus_verification_models",
    f"{CA}.features.corpus_verification_evaluation_models",
    f"{CA}.features.vocabulary_audit",
    f"{CA}.features.descriptive",
    f"{CA}.features.filtering",
    f"{CA}.features.lexical",
    f"{CA}.features.lexical_diversity",
    f"{CA}.features.function_words",
    f"{CA}.features.mfw",
...
DEPENDENCY_RULES = (
    ...
    DependencyRule(
        ...
        (
            ...
            f"{CA}.features.corpus_stylometry_support",
            f"{CA}.features.corpus_verification_service",
            f"{CA}.features.corpus_verification_evaluation_service",
        ),
        (
            "nlpo_toolkit.stylometry.csv_reader",
            "nlpo_toolkit.stylometry.metadata_reader",
